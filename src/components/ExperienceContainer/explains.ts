const EXPLAIN = {
  ...
  tailwindCss:
    '빠른 개발속도를 위해서 css프레임워크인 tailwind를 사용했습니다. 클래스 기반 스타일링을 사용하기 때문에 스타일을 직접 작성하는 시간을 절약하고, 빠르게 UI를 개발할 수 있습니다. 또한 next13부터는 tailwind를 기본적으로 제공하게 되어 선택하게 되었습니다.',
};
